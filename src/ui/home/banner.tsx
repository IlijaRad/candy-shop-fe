      ...
      <div className="mx-auto w-full max-w-7xl px-4 pt-16 sm:px-6 sm:pt-24 lg:px-8">
        <div className="relative overflow-hidden rounded-lg">
          ...
          <div className="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:px-12 sm:py-40 lg:px-16">
            ...
            <Link
              href={buttonLink}
              className="mt-8 block w-full rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-gray-900 transition-colors hover:bg-gray-100 sm:w-auto"
            >
              {buttonText}
            </Link>
          </div>
